...
namespace LeadersBook_ClassLib.Models
{
    public class Soldier : ISoldier<int, int>
    {
        ...
        public ISoldierInformation<int, int, ISoldier<int, int>>? SoldierInfo { get;set; }
        ...
        public IServedCrewWeaponInformation<int, int, ISoldier<int, int>>? ServedCrewWeaponInfo { get;set; }
